...
export const BlockIcon = ({ type, mt }: BlockIconProps): JSX.Element => {
  ...
  switch (type) {
    case BubbleBlockType.TEXT:
      return <TextBubbleIcon color={red} mt={mt} />
    case BubbleBlockType.IMAGE:
      return <ImageBubbleIcon color={red} mt={mt} />
    case BubbleBlockType.VIDEO:
      return <VideoBubbleIcon color={red} mt={mt} />
    case BubbleBlockType.EMBED:
      return <EmbedBubbleIcon color={red} mt={mt} />
    case BubbleBlockType.AUDIO:
      return <AudioBubbleIcon color={red} mt={mt} />
