export default {
  ...
  'billing.preCheckoutModal.taxId.label': 'Identificação fiscal (CNPJ ou CPF):',
  ...
  'billing.pricingCard.once': '/ Parcela úncia',
  ...
  'billing.pricingCard.starter.includedSeats': '2 licenças incluídas',
  ...
  'billing.pricingCard.pro.includedSeats': '5 licenças incluídas',
  'billing.pricingCard.pro.customDomains': 'Domínios personalizados',
  'billing.pricingCard.pro.analytics': 'Análises aprofundadas',
  'billing.pricingCard.ltd.endsSoon': 'Termina em breve',
  'billing.pricingCard.ltd.description': 'Oferta especial por tempo limitado.',
  'billing.pricingCard.ltd.everythingFromStarter': 'Acesso vitalício',
  'billing.pricingCard.ltd.includedSeats': '5 licenças incluídas',
  'billing.pricingCard.ltd.customDomains': 'Domínios personalizados',
  'billing.pricingCard.ltd.analytics': 'Análises aprofundadas',
